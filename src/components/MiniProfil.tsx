  ...
  return (
    <div className='flex mb-4 px-1'>
        ...
        <div className="flex flex-col flex-grow">
            <h4 className={`font-bold font-Poppins text-${ismine == 'yes' ? "white" : "gray-300"}`}>{ismine == 'yes' ? userData?.name : nom}</h4>
            <p className='text-sm text-gray-300'>{ismine == 'yes' ? userData?.surname : prenom}</p>
        </div>
